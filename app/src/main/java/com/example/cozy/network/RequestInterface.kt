...
*/
    ...
    @Headers(
        ...
        "token:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWR4IjozLCJuaWNrbmFtZSI6ImdhaW4zIiwiaWF0IjoxNTk0MzkxMTExLCJleHAiOjE1OTQzOTQ3MTEsImlzcyI6Im91ci1zb3B0In0.JLuPrVZlS88J0T5TShaXmgdgrU3KQ8zSEe3NiVTwEI8"
    )
    @GET("/main/interest")
